...
def notify():
    """
    Docstring for notify: dummy for now, TODO: sends notification to phone one same ip, TODO: sends screenshot

    """
    pass

def capture_selected_bmp(x, y, w, h, save: bool = True):
    ...
    if save:
        bmp.SaveBitmapFile(hdc_mem, "capture.bmp")          # Saves the bmp at address hdc_mem to a disk address
...
def monitor(x,y,w,h, interval: int = 3, auto_off: int = 120):
